...
from command_implementations import play, pause_resume, commands, queue
...
class TestBotFunctions(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_commands(self):
        ...
        self.assertEqual(kwargs['embed'].title, "Bot Commands")
    ...
    async def test_queue(self):
        ...
        self.assertIn('embed', kwargs)
        self.assertIsInstance(kwargs['embed'], discord.Embed)
        self.assertEqual(kwargs['embed'].title, "Song Queue")
